...
const Nav = () => {
  ...
  return (
    <nav className={`font-sans fixed top-0 left-0 right-0 z-50 ${active ? "bg-white text-darkGreen  leaderboard-box-shadow" : "bg-transparent text-white"} transition-all duration-300 ease-in-out`}>
